...
from src.stock_trader.acquisition.data_sources.local_csv import LocalCSVDataSource, TickerNotFoundError
...
DATA_SOURCES = {
    ...
    AlphaVantageDataSource(settings.APP_SETTINGS.alpha_vantage_api_key): DateRange(start=datetime(2023, 7, 1), end=datetime(2023, 9, 20)),
