...
from stock_trader.simulation.portfolio_manager import PortfolioException, PortfolioManager
...
class TradingSimulator:
    ...
    def simulate(self: Self, data: pd.DataFrame, ticker: str, initial_capital: float = 10000.0) -> None:
