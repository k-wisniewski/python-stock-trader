...
class Visualizer(ABC):
    ...
    def _plot_stock_price(self: Self, data: pd.DataFrame, type: str, style: str, volume: bool) -> None:
        mpf.plot(
    ...
    def _save_and_cleanup(self: Self, ticker: str, indicator_names: list[str]) -> None:
        ...
        plt.savefig(APP_SETTINGS.report_output_path / f"{ticker}_{'_'.join(indicator_names)}_{timestamp}.png")
        plt.close()
