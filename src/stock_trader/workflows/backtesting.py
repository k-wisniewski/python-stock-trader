...
from src.stock_trader.reporting.generate_report import create_report, save_report
from src.stock_trader.simulation.portfolio_manager import PortfolioManager
...
class BacktestingWorkflow:
    ...
    def _backtest_single_ticker(self: Self, data: pd.DataFrame, initial_lump_sum: float, ticker: str) -> None:
