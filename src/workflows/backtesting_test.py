...
from acquisition.data_loaders.data_loader import SingleThreadedDataLoader
from acquisition.data_sources.data_source import DataSource
from settings import Settings
from trading_algorithms.signals import MovingAverageCrossoverSignal
...
def test_backtesting_workflow(
    tmp_path: Path, fake_data_source: DataSource, monkeypatch: MonkeyPatch
) -> None:
